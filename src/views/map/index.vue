<template>
    <div class="map-container">
        <div class="side-panel left-panel" :class="{
            ...
            <div class="collapse-trigger-area" @mouseenter="showCollapseButton = 'left'"
                @mouseleave="showCollapseButton = null">
                <button class="collapse-button" @click="mapStore.toggleLeftPanel"
                    v-show="showCollapseButton === 'left' && !isResizing">
                    {{ !mapStore.leftPanelCollapsed ? "◀" : "▶" }}
                </button>
            </div>
            <div v-if="!mapStore.leftPanelCollapsed" class="resize-handle right-handle"
        ...
        <div class="side-panel right-panel" :class="{
            ...
            <div class="collapse-trigger-area" @mouseenter="showCollapseButton = 'right'"
                @mouseleave="showCollapseButton = null">
                <button class="collapse-button" @click="mapStore.toggleRightPanel"
                    v-show="showCollapseButton === 'right' && !isResizing">
                    {{ !mapStore.rightPanelCollapsed ? "▶" : "◀" }}
                </button>
                <div v-if="!mapStore.rightPanelCollapsed" class="resize-handle left-handle"
