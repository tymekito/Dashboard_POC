<template>
  <div>
    <!-- Collapsed Icon -->
    <div v-if="isCollapsed" class="legend-collapsed-icon" @click="showLegend" @mousedown="startIconDrag">📋</div>
...
.bottom-panel {
  ...
  border-radius: 12px;
  color: white;
  transition: all 0.1s ease-out; // Zmienione z 0.3s cubic-bezier na 0.1s ease-out
  z-index: 1000;
  box-shadow: 0 4px 20px rgba(0, 188, 212, 0.3);
  display: flex;
